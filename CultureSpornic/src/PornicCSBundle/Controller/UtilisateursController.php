...
use PornicCSBundle\Entity\Utilisateurs;
use PornicCSBundle\Form\UtilisateursType;
...
class UtilisateursController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('PornicCSBundle:Utilisateurs')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PornicCSBundle\Form\UtilisateursType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('PornicCSBundle\Form\UtilisateursType', $utilisateur);
